...
if($c != ""){ 
$c = testQty($c);
$act = $db->delete("admin_messages", " id='{$c}'");	
$i++;			
}else{
continue;
}
...
<td><?php echo $date; ?></td>
<td><a href="<?php echo $admin; ?>inbox/view/<?php echo $id; ?>/pn/<?php echo $pn; ?>/" class="btn gen-btn general-link" title="View message #<?php echo $id; ?>"><i class="fa fa-eye" aria-hidden="true"></i> View</a></td>
...
<div><a href="<?php echo $admin; ?>inbox/pn/<?php echo $pn; ?>/" class="btn gen-btn general-link"><i class="fa fa-arrow-left"></i> Back to inbox</a></div>
