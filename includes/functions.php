...
$directory = (isset($_SERVER["HTTPS"]) ? "https" : "http") . "://" . $server_name . "/aatren/";
function directory() {
global $directory;
echo $directory;
}
...
$gen_name = "AATREN";
$full_gen_name = "AATREN";
$gen_email = "contact@reliancewisdom.com";
$gen_phone = "+234 (0)803 321 7614";
$date = date("Y-m-d");
...
function cart_tp_input($data) {
$result = ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST[$data]))?test_input($_POST[$data]):"";
if(empty($result) && isset($_SESSION["cart_details"][$data]) && !empty($_SESSION["cart_details"][$data])){
$result = $_SESSION["cart_details"][$data];
}
return $result;
}
...
function search_checked_option($data){
$result = "";
$current_page = basename($_SERVER["PHP_SELF"],".php");
if(isset($_POST[$data])){
$result = $_POST[$data];
...
<img src=\"{$directory}images/reliancemarket-logo.jpg\">
</div>
